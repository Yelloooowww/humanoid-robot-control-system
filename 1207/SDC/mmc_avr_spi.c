...
#define CS_LOW()		PORTF &= ~(0x01 << 4)	/* Set MMC_CS = low */
#define	CS_HIGH()		PORTF |= (0x01 << 4)	/* Set MMC_CS = high */
...
// Don't Use this function, because All delay have done by counting down at local loop
