...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def now_angle_func(self):
        if self.Mode==1:
            ...
            # self.spinBox_6.setValue(50)
            # self.spinBox_7.setValue(50)
            # self.spinBox_8.setValue(50)
            # self.spinBox_9.setValue(50)
            # self.spinBox_10.setValue(50)
            # self.spinBox_11.setValue(50)
            # self.spinBox_12.setValue(50)
            # self.spinBox_13.setValue(50)
            # self.spinBox_14.setValue(50)
            # self.spinBox_15.setValue(50)
            # self.spinBox_16.setValue(50)
