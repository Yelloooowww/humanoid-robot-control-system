...
void identify(uint8_t a,uint8_t b,uint8_t c,uint8_t d){
  if(a==50 && b==230 && c==50 && d==254) printf("UP!!!\n");
  if(a==51 && b==204 && c==51 && d==254) printf("RIGHT!!!\n");
  if(a==50 && b==204 && c==50 && d==254) printf("DOWN!!!\n");
  if(a==51 && b==230 && c==51 && d==254) printf("LEFT!!!\n");

  if(a==49 && b==230 && c==49 && d==254) printf("UP~~~\n");
  if(a==48 && b==204 && c==48 && d==254) printf("RIGHT~~~\n");
  if(a==49 && b==204 && c==49 && d==254) printf("DOWN~~~\n");
  if(a==48 && b==230 && c==48 && d==254) printf("LEFT~~~\n");
}
...
int main(void)
{
	...
	while(1)
  {
	  for(int j=0;j<100;j++){
        if(j%4 ==0){
          printf("\n");
          identify(get[j-4],get[j-3],get[j-2],get[j-1]);
